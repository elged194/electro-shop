...
const ProductCenter = () => {
  const products = [
    { id: 1, name: "Product 1", img: "https://via.placeholder.com/800x600?text=800x600", price: 100.59 },
    { id: 2, name: "Product 2", img: "https://via.placeholder.com/800x600?text=800x600", price: 200.59 },
    { id: 3, name: "Product 3", img: "https://via.placeholder.com/800x600?text=800x600", price: 300.59 }
  ];
