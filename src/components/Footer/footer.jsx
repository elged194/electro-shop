...
const Footer = () => {
  return (
    <>
      {/* hearo footer */}
      <section className="py-3 px-14 w-full flex items-center justify-between bg-yellow-400 ">
        ...
        <div className="">
          <div className="overflow-hidden rounded-full">
            <input
              type="email"
              className="py-2 px-5 w-72 border-none focus:outline-none bg-white"
      ...
      <div className="flex justify-between items-center py-2 px-14 bg-gray-200">
        ...
        <div className=" w-4/12 flex justify-end items-center">
            <img src="https://via.placeholder.com/30x30?text=35x30" className="mx-2" alt="" />
            <img src="https://via.placeholder.com/30x30?text=35x30" className="mx-2" alt="" />
            <img src="https://via.placeholder.com/30x30?text=35x30" className="mx-2" alt="" />
            <img src="https://via.placeholder.com/30x30?text=35x30" className="mx-2" alt="" />
        </div>
